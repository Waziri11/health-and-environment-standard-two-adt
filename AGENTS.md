# Health and Environment Pupil’s Book Standard Two — ADT Bundle Reference
...
**Health and Environment Pupil’s Book Standard Two** — This is an English-language primary textbook from Tanzania, published by the Tanzania Institute of Education for Standard Two pupils, roughly early elementary level. It introduces young learners to basic health and environmental topics such as living and non-living things, domestic and wild animals, road and environmental safety signs, cleaning surroundings, preventing disease, and planting trees and flowers. The book uses a practical, competency-based approach with observation, role-play, songs, poems, case studies, and simple activities that encourage pupils to apply healthy and environmentally responsible habits in school and at home.
...
```
HEALTH-AND-ENVIRONMENT-STD-TWO-2-2024/
├── adt/                              # THE WEB APP
...
├── HEALTH-AND-ENVIRONMENT-STD-TWO-2-2024.db                    # SQLite database (pipeline state)
├── HEALTH-AND-ENVIRONMENT-STD-TWO-2-2024.pdf                   # Original source PDF
...
| `pg{NNN}_im{NNN}` | Image alt text / description | `pg006_im002` |
...
{
  "pg001_gp001_tx001": "",
  "pg006_im002": "QR code for additional learning resources from the TIE e-Library.",
  "gl001": "activity",
  "gl001_def": "A task or exercise done to help learning.",
  "qz001_que": "Which group do trees, flowers, and grasses belong to?",
  "qz001_o0": "1) Non-living things",
  "qz001_o0_exp": "❌ Try again. Non-living things do not grow or live, but trees, flowers, and grasses are living things."
}
```
...
```json
{
  "activity": {
    "word": "activity",
    "definition": "A task or exercise done to help learning.",
...
```json
{
  "title": "Health and Environment Pupil’s Book Standard Two",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en"
...
<body>
    <div id="content" class="opacity-0">
        <section role="article" data-section-type="text_and_single_image"
            ...
            <img data-id="pg006_im002" src="images/pg006_im002.png" ...>
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">Which group do trees, flowers, and grasses belong to?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="❌ Try again. Non-living things do not grow or live, but trees, flowers, and grasses are living things." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) Non-living things</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `HEALTH-AND-ENVIRONMENT-STD-TWO-2-2024.pdf` |
| Pipeline database | `HEALTH-AND-ENVIRONMENT-STD-TWO-2-2024.db` (SQLite) |
